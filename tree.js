(function() {
  function TreePlugin(options) {
    ...
    this.canvas.style.top = "-70%"
    this.canvas.style.left= 0
    this.canvas.style.zIndex = -1
    this.canvas.style.width = "100%"
    this.canvas.style.height = 1000
  ...
  TreePlugin.prototype.resize = function () {
    ...
    this.stageWidth = document.getElementById("treeContainer").clientWidth;
    this.stageHeight = document.getElementById("treeContainer").clientHeight*1.7;
  ...
  TreePlugin.prototype.createBranch = function (startX, startY, angle, depth) {
    ...
    var len = (depth === 0 ? this.random(0, 11) : this.random(0, 11)) * scale;
